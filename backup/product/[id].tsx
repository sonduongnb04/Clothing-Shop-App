...
export default function ProductDetailScreen() {
    ...
    const fetchProductDetails = async () => {
      try {
        ...
        const checkWishlist = async () => {
          try {
            const isInWishlistStatus = await isInWishlist(id as string, user?.id || undefined);
  ...
  const handleAddToCart = async () => {
    ...
    try {
      ...
      await addToCart(product, quantity, undefined, undefined, undefined);
      Alert.alert(
        'Thành công',
  ...
  const toggleWishlist = async () => {
    ...
    try {
      ...
      if (isWishlisted) {
        ...
        await removeFromWishlist(product._id, user?._id || undefined);
        ...
        await addToWishlist(product, user?._id || undefined);
